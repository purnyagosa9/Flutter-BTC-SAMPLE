...
class BTCCurrentPriceModel extends BTCCurrentPrice {
  BTCCurrentPriceModel(
    Map<String, Object> mockJsonData, {
    this.time,
    this.disclaimer,
    this.chartName,
    this.bpi,
  ...
  BTCCurrentPriceModel.fromJson(Map<String, dynamic> json) {
